...
function setup() {
    ...
    if (localStorage["getItem"]("HighestScore") == undefined) { localStorage["setItem"]("HighestScore", 0) };
    ...
    restart = createSprite(trex.x + 250, 140);
...
function draw() {
    ...
    if (gameState === PLAY) {
        ...
        if (ground.x < trex.x - 50) {
            ground.x = ground.width / 2 + trex.x + 50;
        }
...
function spawnClouds() {
    ...
    if (frameCount % 60 === 0) {
        ...
        cloud.scale = 0.5;
        cloud.velocityX = trex.velocityX - 3;
